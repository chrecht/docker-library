...
echo "display_startup_errors=1" >> /etc/php/8.3/cli/conf.d/zzz_debug.ini
echo "log_errors=1" >>  /etc/php/8.3/cli/conf.d/zzz_debug.ini
echo "expose_php=1" >>  /etc/php/8.3/cli/conf.d/zzz_debug.ini
